...
type BaseSerializable = string | boolean | BaseGameObject | null | undefined;
...
type BaseSerialized = string | number | boolean | null | undefined;
 ...
 *
 * @param state - The variable you want to serialize. Anything in the game
 * should be Serializable: numbers, strings, BaseGameObjects, dicts, lists,
 * nulls, etc.

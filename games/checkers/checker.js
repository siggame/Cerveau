...
var Checker = Class(GameObject, {
    ...
    init: function(data) {
         ...
         * @type {boolean}
         */
        this.kinged = serializer.defaultBoolean(data.kinged);
         ...
         * @type {Player}
         */
        this.owner = serializer.defaultGameObject(data.owner);
         ...
         * @type {number}
         */
        this.x = serializer.defaultInteger(data.x);
         ...
         * @type {number}
         */
        this.y = serializer.defaultInteger(data.y);

        this._addSerializableKeys(["kinged", "owner", "x", "y"]);

// Note: this should be generated by the new codegen, but so basic it should never need to be overridden because it can't change
var Class = require("../../structures/class");
var GeneratedGame = require("./generatedGame");

...
var Game = Class(TurnBasedGame, {
    ...
    init: function(data) {
         ...
         * @type {number}
         */
        this.boardHeight = serializer.defaultInteger(data.boardHeight);
         ...
         * @type {number}
         */
        this.boardWidth = serializer.defaultInteger(data.boardWidth);
         ...
         * @type {Checker}
         */
        this.checkerMoved = serializer.defaultGameObject(data.checkerMoved);
         ...
         * @type {boolean}
         */
        this.checkerMovedJumped = serializer.defaultBoolean(data.checkerMovedJumped);
        ...
        this._addSerializableKeys(["boardHeight", "boardWidth", "checkerMoved", "checkerMovedJumped", "checkers"]);
